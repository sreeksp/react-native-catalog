...
};var _reactNative = require('react-native');var absoluteStretch = { position: 'absolute', top: 0, left: 0, bottom: 0, right: 0 };exports.default = _reactNative.StyleSheet.create({ container: _extends({}, absoluteStretch, { justifyContent: 'center' }), menu: _extends({}, absoluteStretch), frontView: { flex: 1, position: 'absolute', left: 0, top: 0, backgroundColor: 'transparent', overflow: 'hidden' }, overlay: _extends({}, absoluteStretch, { backgroundColor: 'transparent' }) });